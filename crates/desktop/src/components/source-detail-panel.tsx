				...
				<div className="grid grid-cols-2 gap-2">
					{members.map((member) => (
						<button
							...
							className="flex flex-col gap-1 rounded-lg border border-border/60 bg-surface-secondary p-3 text-left transition-colors duration-[var(--dur-fast)] hover:border-border hover:bg-default"
						>
