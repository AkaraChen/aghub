export default {
	...
	usageLayoutResetOverride: "重設為預設",
	usageLayoutRestoreDefault: "恢復預設佈局",
	usageLayoutUseDefault: "使用預設佈局",
	usageLayoutDefaultRestored: "預設卡片佈局已恢復",
	usageUndo: "復原",
	usageLayoutAutosaveHint: "變更會自動儲存。",
	usageLayoutKeyboardHint: "空白鍵拾取 · 方向鍵移動",
	usageLayoutLivePreview: "即時預覽",
	usageLayoutPreviewAgent: "預覽 Agent：{{agent}}",
	usageLayoutFields: "欄位",
	usageLayoutFieldsDescription: "使用眼睛按鈕顯示或隱藏欄位。",
	usageLayoutQuotaFields: "額度",
	usageLayoutStatFields: "統計",
	usageLayoutShowField: "顯示{{field}}",
	usageLayoutHideField: "隱藏{{field}}",
