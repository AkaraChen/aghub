export default {
	...
	globalHooksCount: "{{count}} 個全域 hook",
	createHook: "建立 hook",
	editHook: "編輯 hook",
	deleteHook: "刪除 hook",
	deleteHookConfirm: "確定要刪除「{{event}}」hook 嗎？此操作無法復原。",
	noHooks: "尚無 hooks",
	noHooksMatch: "沒有匹配的 hooks",
	searchHooks: "搜尋 hooks...",
	hookEvent: "事件",
	hookMatcher: "Matcher",
	hookActionType: "動作類型",
	hookCommand: "命令",
	...
	hookTool: "MCP 工具",
	hookTimeout: "逾時秒數",
	hookStatusMessage: "狀態訊息",
	hookStatusMessagePlaceholder: "hook 執行時顯示",
	hookIfCondition: "條件",
	hookAsync: "非同步執行",
	hookPromptPlaceholder: "Prompt 內容",
	hookCreated: "Hook 已建立",
	hookUpdated: "Hook 已更新",
	hookDeleted: "Hook 已刪除",
	hookLoadError: "載入 hooks 失敗",
	hookSaveError: "儲存 hook 失敗",
	hookDeleteError: "刪除 hook 失敗",
	hookEventRequired: "事件必填",
	hookCommandRequired: "命令必填",
	hookUrlRequired: "URL 必填",
	hookPromptRequired: "Prompt 必填",
	hookServerRequired: "MCP 伺服器必填",
	hookToolRequired: "MCP 工具必填",
	hookTimeoutInvalid: "逾時必須大於 0",
	codexGlobalHookTarget:
		"新的 Codex hook 會儲存到 ~/.codex/hooks.json；既有 hook 會在原來源檔案中更新。",
	claudeGlobalHookTarget: "Claude hook 會儲存到 ~/.claude/settings.json。",
