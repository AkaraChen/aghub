export default {
	...
	// Plugin Market
	pluginMarket: "插件市場",
	pluginMarketDescription: "從官方市場探索和安裝插件",
	pluginInfo: "插件資訊",
	installPlugin: "安裝插件",
	pluginInstalled: "插件 '{{id}}' 安裝成功",
	noPluginsFound: "未找到插件",
	noPluginsAvailable: "市場暫無可用插件",
	updateMarketplace: "更新插件市場",
	marketplaceUpdated: "市場已更新",
	marketplaceUpdateFailed: "更新市場失敗",
	refreshing: "刷新中...",
	browseMarketplace: "瀏覽市場",
	availablePluginsCount: "{{count}} 個可用",
	discoverPlugins: "發現 {{count}} 個插件",
	installedPluginsCount: "{{count}} 個已安裝",
	uninstallPlugin: "卸載插件",
	uninstall: "卸載",
	reinstallPlugin: "重新安裝插件",
	reinstall: "重新安裝",
	confirmUninstallTitle: "確認卸載",
	confirmUninstallDescription: "確定要卸載 '{{name}}' 嗎？此操作無法撤銷。",
	confirmReinstallTitle: "確認重新安裝",
	confirmReinstallDescription: "這將重新安裝 '{{name}}' 並保留您的配置。",
	pluginUninstalled: "插件卸載成功",
	pluginsUninstalled: "已卸載 {{count}} 個插件",
	pluginReinstalled: "插件重新安裝成功",
	reinstallFailed: "重新安裝插件失敗: {{error}}",
	bulkUninstallPluginsConfirm:
		"確定要卸載這 {{count}} 個被選中的插件嗎？這會移除每個插件目前已安裝的所有 scope。",
	bulkUninstallPluginsFailed: "批次卸載插件失敗: {{error}}",
