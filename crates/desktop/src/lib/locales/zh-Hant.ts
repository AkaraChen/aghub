export default {
	...
	usageRuntimeSourceEnvironment: "環境變數覆寫",
	usageRuntimeSourceManual: "自訂二進位",
	usageRuntimeSourcePath: "系統 PATH",
	usageRuntimeSourceBun: "使用 Bun 安裝",
	usageRuntimeSourceNpm: "使用 npm 安裝",
	usageRuntimeSourceDownload: "直接下載",
	usageRuntimeSourceBundled: "內建備用版本",
	usageRuntimeAutoDescription:
		"依序使用環境變數覆寫、PATH、應用程式管理的安裝和內建備用版本。",
	usageRuntimeExternalDescription: "使用現有的 ccusage，不會修改它。",
	usageRuntimeBundledDescription: "使用目前 aghub 版本隨附的唯讀副本。",
	usageRuntimeManagedInstalledDescription:
		"使用安裝在 aghub 應用程式資料目錄中的副本。",
	usageRuntimeManagedInstallDescription:
		"將驗證過的 ccusage 原生二進位安裝到 aghub 應用程式資料目錄。",
	usageRuntimeExternalManaged:
		"此執行來源由 aghub 外部管理。在這裡更新會另外安裝一份由應用程式管理的副本。",
	...
	usageRuntimeUse: "使用",
	usageRuntimeInstall: "安裝",
	usageRuntimeInstallManaged: "在 aghub 中安裝最新版",
	usageRuntimeUpdate: "更新",
	...
	usageExtraArgsDescription: "原樣追加到每次 ccusage 呼叫。",
	...
	usageHomeWindowsLabel: "限額條",
	usageHomeStatsLabel: "底部指標",
