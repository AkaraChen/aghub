export default {
	...
	usageRuntimeSourceManual: "自訂執行檔",
	usageRuntimeSourcePath: "系統 PATH",
	usageRuntimeSourceBun: "Bun 管理副本",
	...
	usageRuntimeInstallSource: "安裝{{source}}",
	usageRuntimeInstallVersion: "在 aghub 中安裝 {{version}}",
