export default {
	...
	gatewayNewVersion: "新版本 v{{version}}",
	gatewayTabUpstream: "上游 Key",
	gatewayOfficialKeysTitle: "官方 API Key",
	gatewayOfficialKeysDescription:
		"閘道直連 Gemini、Claude、Codex 官方介面所用的 API Key。",
	gatewayNoUpstreamKeys: "暫無 API Key。",
	gatewayCompatTitle: "中轉站 (OpenAI 相容)",
	gatewayCompatDescription: "OpenAI 相容的中轉、聚合類上游。",
	gatewayAddCompatProvider: "新增中轉站",
	gatewayNoCompatProviders: "暫無中轉站。",
	gatewayCompatModelCount: "{{count}} 個模型",
	gatewayDeleteUpstream: "刪除上游",
	gatewayDeleteUpstreamConfirm: "確定刪除「{{name}}」？此操作無法復原。",
	gatewayUpstreamKeyDeleted: "API Key 已刪除",
	gatewayCompatProviderDeleted: "中轉站已刪除",
	gatewayUpstreamDeleteFailed: "刪除上游失敗",
	gatewayAddUpstreamKey: "新增 API Key",
	gatewayUpstreamApiKey: "API Key",
	gatewayUpstreamBaseUrl: "位址（可選）",
	gatewayUpstreamBaseUrlPlaceholder: "留空使用官方位址",
	gatewayUpstreamKeyAdded: "API Key 已新增",
	gatewayUpstreamAddFailed: "新增上游失敗",
	validationGatewayApiKeyRequired: "請填寫 API Key",
	gatewayImportFromInference: "從推理 Provider 匯入",
	gatewayImportFromInferenceNone: "手動填寫",
	gatewayCompatProviderAdded: "中轉站已新增",
	gatewayCompatModels: "模型（可選，逗號分隔）",
	gatewayCompatModelsPlaceholder: "gpt-4o, deepseek-chat",
	gatewayResetQuota: "重設配額狀態",
	gatewayQuotaReset: "配額狀態已重設",
	gatewayQuotaResetFailed: "重設配額狀態失敗",
	gatewayManagedProviderTooltip: "由閘道管理",
	gatewayManagedProviderNotice:
		"此條目由閘道自動鏡像，本機修改會在下次同步時被覆蓋。",
	gatewayDeviceCodeHint: "在開啟的頁面確認此代碼",
	gatewayDeviceCodeCopy: "拷貝代碼",
	gatewayDeviceCodeCopied: "代碼已拷貝",
	gatewayDeviceCodeCopyFailed: "拷貝代碼失敗",
	gatewayDeviceCodeExpiresIn: "{{time}} 後失效",
	gatewayTabLogs: "日誌",
	gatewayLogsLineCount: "{{count}} 行",
	gatewayLogsClear: "清空",
	gatewayLogsClearConfirm: "確定清空日誌？此操作無法復原。",
	gatewayLogsCleared: "日誌已清空",
	gatewayLogsClearFailed: "清空日誌失敗",
	gatewayLogsEmpty: "暫無日誌。",
	gatewayLogsDisabled: "檔案日誌未開啟",
	gatewayLogsDisabledDescription: "開啟後閘道會把日誌寫入檔案，可在此查看。",
	gatewayLogsEnable: "開啟檔案日誌",
	gatewayLogsLoadFailed: "載入日誌失敗",
	gatewayExcludedModelsTitle: "模型排除",
	gatewayExcludedModelsDescription: "限制 OAuth 帳號可用的模型。",
	gatewayExcludedModelsHint: "模型名支援萬用字元，如 gemini-1.5*。",
	gatewayExcludedModelsAddRule: "新增規則",
	gatewayExcludedModelsEmpty: "暫無排除規則。",
	gatewayExcludedModelPlaceholder: "輸入模型名後按 Enter",
	gatewayExcludedModelsSaved: "模型排除已儲存",
	gatewayExcludedModelsSaveFailed: "儲存模型排除失敗",
	gatewayImportVertex: "匯入 Vertex",
	gatewayVertexImported: "Vertex 服務帳號已匯入",
	gatewayVertexImportFailed: "匯入 Vertex 服務帳號失敗",
	gatewayVertexReadFailed: "讀取檔案失敗",
	gatewayBinSourceEnv: "來源：AGHUB_CLIPROXY_BIN 環境變數",
	gatewayBinSourceDownloaded: "來源：aghub 下載 (v{{version}})",
	gatewaySystemBinHint:
		"偵測到系統安裝：{{path}} — 如需使用，請設定 AGHUB_CLIPROXY_BIN 指向它",
	gatewayInstallAndStart: "安裝並啟動",
	gatewayInstall: "安裝",
	gatewayLaunchPreparing: "準備中…",
	gatewayLaunching: "啟動中…",
	...
	gatewayMirrorDescription:
		"留空則從 GitHub 下載。鏡像需提供與 GitHub releases 相同的 /releases/download 路徑佈局。",
	gatewayMirrorSaved: "下載來源已儲存",
	gatewayCliproxySettings: "CLIProxyAPI 設定",
	gatewayRemoteInstances: "遠端實例",
	gatewayNoRemoteInstances: "尚未連接遠端實例。",
	gatewayAddExternal: "連接遠端實例",
	gatewayKindExternal: "外部",
	gatewayStatusNotProvisioned: "未下載",
	gatewayStatusStopped: "已停止",
	gatewayStatusStarting: "啟動中",
	gatewayStatusRunning: "執行中",
	gatewayStatusUnhealthy: "異常",
	gatewayStart: "啟動",
	gatewayStop: "停止",
	gatewayAutoStart: "隨 aghub 啟動",
	gatewayInstanceStarted: "實例已啟動",
	gatewayInstanceStopped: "實例已停止",
	gatewayStartFailed: "啟動實例失敗",
	gatewayStopFailed: "停止實例失敗",
	gatewayInstanceUpdated: "實例已更新",
	gatewayUpdateFailed: "更新實例失敗",
	gatewayDeleteInstance: "刪除實例",
	gatewayDeleteInstanceConfirm: "確定刪除「{{name}}」？此操作無法復原。",
	gatewayInstanceDeleted: "實例已刪除",
	gatewayDeleteFailed: "刪除實例失敗",
	gatewayInstanceCreated: "實例已建立",
	gatewayCreateFailed: "建立實例失敗",
	gatewayPort: "連接埠",
	gatewayBaseUrl: "位址",
	gatewayManagementKey: "Management key",
	gatewayConnect: "連接",
	gatewayExternalNamePlaceholder: "如：伺服器閘道",
	validationGatewayNameRequired: "請填寫名稱",
	validationGatewayBaseUrlRequired: "請填寫位址",
	validationGatewayManagementKeyRequired: "請填寫 management key",
	gatewayProvisionDownloading: "下載中…",
	gatewayProvisionReady: "CLIProxyAPI 已下載",
	gatewayProvisionFailed: "下載 CLIProxyAPI 失敗",
	gatewayVersionInstalled: "已安裝",
	gatewayVersionPinned: "鎖定版本",
	gatewayVersionLatest: "最新",
	gatewayTabAccounts: "上游帳號",
	gatewayTabKeys: "閘道 Key",
	gatewayTabConfig: "config.yaml",
	gatewayTabUsage: "用量",
	gatewayInstanceNotRunning: "實例未執行",
	gatewayInstanceNotRunningDescription:
		"啟動實例後才能管理帳號、Key 與設定。",
	gatewayAccountsDescription: "實例轉送請求所用的上游訂閱帳號。",
	gatewayAddAccount: "新增帳號",
	gatewayAddAccountExternalHint:
		"外部實例無法接收 OAuth 回呼，請先在本機實例登入，再把憑證推送過來（帳號漫遊）。",
	gatewayNoAccounts: "暫無上游帳號",
	gatewayNoAccountsDescription: "新增訂閱帳號後，閘道才能轉送請求。",
	gatewayAccountProvider: "Provider",
	gatewayAccountEmail: "帳號",
	gatewayAccountStatus: "狀態",
	gatewayAccountModified: "修改時間",
	gatewayUsageSuccess: "成功",
	gatewayUsageFailed: "失敗",
	gatewayUsageIdentifier: "上游標識",
	gatewayPushAccount: "推送到其他實例",
	gatewayPushTo: "推送到 {{name}}",
	gatewayAccountPushed: "憑證已推送到 {{name}}",
	gatewayPushFailed: "推送憑證失敗",
	gatewayDeleteAccount: "刪除帳號",
	gatewayDeleteAccountConfirm: "確定刪除「{{name}}」？此操作無法復原。",
	gatewayAccountDeleted: "帳號已刪除",
	gatewayDeleteAccountFailed: "刪除帳號失敗",
	gatewayOauthProviderLabel: "Provider",
	gatewayOauthStart: "用瀏覽器登入",
	gatewayOauthWaiting: "等待瀏覽器完成授權…",
	gatewayOauthSuccess: "帳號已新增",
	gatewayOauthFailed: "登入失敗",
	gatewayOauthTimeout: "等待授權逾時",
	gatewayKeysDescription: "coding agent 用第一個 key 存取閘道。",
	gatewayAddKey: "新增 Key",
	gatewayKeyPlaceholder: "sk-…",
	gatewayKeysSaved: "閘道 Key 已儲存",
	gatewayKeysSaveFailed: "儲存閘道 Key 失敗",
	gatewayNoKeys: "暫無 Key，新增一個供 coding agent 接入。",
	gatewaySettingGroupLogging: "日誌",
	gatewaySettingGroupUsage: "用量",
	gatewaySettingGroupSecurity: "安全",
	gatewaySettingGroupNetwork: "網路",
	gatewaySettingGroupQuota: "配額",
	gatewaySettingUpdated: "設定已儲存",
	gatewaySettingUpdateFailed: "儲存設定失敗",
	gatewaySettingsWarningsTitle: "部分設定讀取失敗",
	gatewaySettingUnavailable: "不可用",
	gatewayConfigDescription:
		"routing 策略、模型別名等沒有專屬介面的進階項在此編輯。",
	gatewayConfigHotReload: "儲存即熱生效。",
	gatewayConfigSaved: "config.yaml 已儲存",
	gatewayConfigSaveFailed: "儲存 config.yaml 失敗",
	gatewayNoUsage: "暫無用量資料",
	gatewayNoUsageDescription: "經此閘道轉送的請求會在這裡統計。",
