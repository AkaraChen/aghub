export default {
	...
	transferApplied: "已傳輸到 {{count}} 個目標",
	transferDescription: "將 {{name}} 從 {{source}} 複製到：",
	noTransferDestinations: "沒有可用的傳輸目標。",
	selectDestinationScope: "選擇目標範圍",
	selectScopePlaceholder: "選擇範圍...",
	selectAgentsForTransfer: "選擇要傳輸到 {{destination}} 的代理：",
