export default {
	...
	// Gateway
	gateway: "閘道",
	gatewayPageDescription:
		"託管本機 LLM 閘道，或連接已在執行的 CLIProxyAPI 實例。",
	gatewayAddManaged: "託管本機閘道",
	gatewayAddExternal: "連接現有實例",
	gatewayEmptyManagedDescription:
		"aghub 自動下載 CLIProxyAPI 二進位檔並管理處理程序。",
	gatewayEmptyExternalDescription:
		"填寫位址與 management key，連接已在別處執行的 CLIProxyAPI。",
	gatewayKindManaged: "託管",
