export default {
	...
	usagePathBrowse: "瀏覽",
	usagePathReset: "還原預設",
	usageSidecarPath: "自訂 ccusage 路徑",
	usageSidecarPathDescription:
		"ccusage 二進位的絕對路徑。重新啟動 aghub 後生效。",
	...
	usageHomeLayoutDescription: "排序並選擇每張卡片顯示的限額條與指標。",
	usageHomeWindowsLabel: "限額條",
	usageHomeStatsLabel: "底部指標",
	usageLayoutHide: "移除 {{label}}",
	usageLayoutShow: "新增 {{label}}",
	usageLayoutDrag: "拖曳 {{label}}",
	...
	usageLayoutFullHint: "卡片已滿。將欄位拖到已顯示欄位上即可替換。",
	usageLayoutDrawerEmpty: "拖到這裡即可隱藏欄位。",
	usageLayoutEmptyCard: "全部隱藏了——從右側加回欄位。",
