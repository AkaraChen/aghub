export default {
	...
	subAgents: "子Agent",
	subAgent: "子Agent",
	createSubAgent: "建立子Agent",
	editSubAgent: "編輯子Agent",
	deleteSubAgent: "刪除子Agent",
	noSubAgents: "尚無子Agent",
	noSubAgentsDescription: "建立你的第一個子Agent。",
	searchSubAgents: "搜尋子Agent...",
	subAgentName: "名稱",
	subAgentDescription: "描述",
	subAgentInstruction: "指令",
	subAgentCreated: "子Agent已建立",
	subAgentUpdated: "子Agent已更新",
	subAgentDeleted: "子Agent已刪除",
	createSubAgentError: "建立子Agent失敗",
	subAgentNoInstruction: "未設定指令。",
	deleteSubAgentConfirm: "確定要刪除「{{name}}」嗎？此操作無法復原。",
	updateSubAgentError: "更新子Agent失敗",
	deleteSubAgentError: "刪除子Agent失敗",
	...
	noAgentsDescription: "安裝 Agent 後即可在此管理。",
	searchAgentsLabel: "搜尋 Agent",
	searchAgents: "搜尋 Agent...",
	agentStatusFilterLabel: "按狀態篩選 Agent",
	noAgentsMatch: "沒有符合的 Agent",
	...
	whatsNewFeatures: "新增功能",
	whatsNewImprovements: "改進",
	whatsNewFixes: "修正與維護",
	onboardingSkip: "跳過",
	onboardingBack: "返回",
	onboardingNext: "下一步",
	...
	agentManagementDescription:
		"管理哪些 Agent 可用於建立技能和 MCP 伺服器。停用你不使用的 Agent。",
	globalConfig: "全域設定",
	cli: "命令列工具",
	ide: "IDE",
	desktop: "桌面應用程式",
	cloud: "雲端",
	remoteWorkspace: "遠端工作區",
	detectedVia: "透過 {{sources}} 偵測到",
	supportedAgents: "aghub 支援的 Agent",
	configurationCanBePrepared: "可以預先準備設定",
	configurationFoundRuntimeUnknown: "已找到設定，但尚未確認用戶端執行環境",
	detectionFailedCanPrepare: "偵測失敗，仍可預先準備設定",
	detectionUnknownCanPrepare: "暫無可靠偵測方式，仍可預先準備設定",
	prepareConfigRuntimeUnconfirmed:
		"aghub 將準備設定檔案，但尚未確認這個 Agent 的執行環境。",
	available: "可用",
	notAvailable: "不可用",
	disabledByUser: "已停用",
	toggleAgent: "切換 {{name}}",
	...
	deleteMcpMultipleConfirm:
		"將從 {{count}} 個 Agent 中移除「{{name}}」（{{agents}}）。此操作無法復原。",
	deleting: "刪除中...",
	editMcpServer: "編輯 MCP 伺服器",
	multipleAgents: "多個 Agent",
	changeWillApplyToAgents: "此變更將套用於 {{count}} 個 Agent：{{agents}}",
	name: "名稱",
	serverName: "伺服器名稱",
	transportType: "傳輸類型",
	env: "環境變數",
	...
	noAgentsAvailableHelp: "請先安裝或啟用至少一個支援元件管理的 Agent。",
	...
	validationAgentsRequired: "請至少選擇一個 Agent。",
	...
	manageAgentsTooltip: "選擇使用此伺服器的 Agent",
	adding: "新增",
	removing: "移除",
	alreadyAdded: "已新增",
	...
	unconfigured: "未設定",
	applyChanges: "套用變更",
	agentChangesApplied: "已成功更新 {{count}} 個 Agent",
	...
	selectAgentsForMcp: "選擇哪些 Agent 應安裝此 MCP 伺服器：",
	noTargetAgents: "沒有可用的 Agent。",
	installed: "已安裝",
	globalScope: "全域範圍",
	unknownError: "發生未知錯誤",
	universalSkills: "通用",
	universalSkillsTooltip: "共享給: {{agents}}",
	universalSkillsDescription: "{{count}} 個 Agent 共用此技能路徑",
	...
	installSkill: "安裝技能",
	selectSourceAndAgents: "選擇來源和 Agent",
	installation: "安裝",
	install: "安裝",
	...
	selectAgentsForSkill: "選擇要安裝此技能的 Agent：",
	selectAgentsForSubAgent: "選擇應使用此子Agent的 Agent Harness：",
	installs: "安裝量",
	...
	executableMcpWarningDescription:
		"Stdio MCP 伺服器是 Agent 稍後可能執行的可執行命令。只有在你信任來源，並已檢視下方所有命令、參數和環境變數後才安裝。",
	confirmExecutableMcp:
		"我了解此匯入會持久保存一個可執行命令，供 Agent 稍後執行。",
	...
	library: "技能庫",
	market: "市集",
	marketSubtitle: "探索技能、MCP 伺服器與開箱即用的 Agent 套件。",
	marketSections: "市集區段",
	...
	marketMcpInstallMethod: "安裝方式",
	marketMcpMethodCount: "{{count}} 種安裝方式",
	marketMcpChooseLocation: "選擇已安裝位置",
	...
	marketMcpNoMatchesLoaded:
		"已載入的結果中尚無符合項目，仍有更多結果可載入。",
	marketMcpSource: "來源",
	marketMcpSourceRegistry: "MCP Registry",
	...
	marketMcpSourceUrlHint: "須在公開 HTTP(S) 端點提供 MCP Registry API。",
	...
	clearAgentFilter: "清除 Agent 篩選",
	agentFilterAllAgents: "全部 Agent",
	agentFilterIdleLabel: "按 Agent 篩選",
	agentFilterActiveLabel: "正在篩選 {{name}} — 點擊更換",
	agentFilterChangeLabel: "更換 Agent 篩選",
	...
	sidebarShowLess: "收起",
	homeTitle: "Agent Hub",
	homeSubtitle: "管理本機 Agent Harness 的模型、技能、MCP 與用量。",
	open: "開啟",
	manage: "管理",
	model: "模型",
	manageAgentHarnesses: "管理 Agent Harness",
	manageAgentHarnessesHint: "管理本機已識別的 Agent Harness。",
	browseLibrary: "瀏覽技能庫",
	quickActions: "快捷操作",
	agentStatusReady: "就緒",
	...
	agentMissingHint: "此 Agent Harness 尚未安裝。請先安裝其 CLI，再來此管理。",
	agentDisabledHint: "此 Agent Harness 已停用。請前往設定重新啟用。",
	modelNotConfigurableTitle: "模型由 Agent 自行管理",
	modelNotConfigurableHint: "{{name}} 從自身設定讀取模型配置，這裡無需管理。",
	agentSections: "Agent 區段",
	...
	globalSearchLabel:
		"搜尋 Agent、技能、MCP 伺服器、子Agent、提示詞、規則與技能庫",
