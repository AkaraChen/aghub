export default {
	...
	usageRuntimeSource: "运行来源",
	usageRuntimeSourceAuto: "自动选择",
	usageRuntimeSourceEnvironment: "环境变量",
	usageRuntimeSourceManual: "自定义可执行文件",
	usageRuntimeSourcePath: "系统 PATH",
	usageRuntimeSourceBun: "Bun 管理副本",
	usageRuntimeSourceNpm: "npm 管理副本",
	usageRuntimeSourceDownload: "下载副本",
	usageRuntimeSourceBundled: "内置备用版本",
	usageRuntimeSourceInstallable: "可安装",
	usageRuntimeAutoDescription:
		"依次检查环境变量、系统 PATH、aghub 管理的副本和内置备用版本。",
	usageRuntimeActiveSourceDescription: "当前使用{{source}}",
	...
	usageRuntimeInstallSource: "安装{{source}}",
	usageRuntimeInstallVersion: "在 aghub 中安装 {{version}}",
	...
	usageGlobalAlertThreshold: "全局告警阈值",
	usageAlertUseGlobal: "使用全局（{{pct}}%）",
	usageSettingsHomeCards: "主页卡片",
	usageSettingsTrackedAgents: "用量来源",
	usageSettingsTrackedAgentsDescription:
		"选择 aghub 要向 ccusage 查询的 Agent；该设置同时控制 token 汇总和受支持的限额检查。",
	usageTrackedAgentsLoadError: "无法加载 ccusage Agent 来源",
	usageAgentTracked: "追踪 {{agent}} 用量",
	usageNoTrackedAgents: "尚未启用任何用量来源",
	usageExtraArgs: "额外 ccusage 参数",
	usageExtraArgsDescription: "按空白字符分隔；单个参数值不能包含空格。",
	usageSettingsAlerts: "告警",
	usageSettingsAlertsDescription: "当限额窗口超过阈值时提醒。",
