export default {
	...
	usageDashboardHint: "用于主页 agent 卡片上的用量区块。",
	...
	usageGlobalAlertThresholdDescription: "当某个限额窗口超过该百分比时告警。",
	usageAlertUseGlobal: "使用全局",
	...
	usageLayoutPreview: "主页卡片",
	usageLayoutAvailable: "可选字段",
	usageLayoutEmptyZone: "拖字段到这里",
	...
	usageAgentAlertResolved: "实际为 {{pct}}%",
