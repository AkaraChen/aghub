export default {
	...
	transferApplied: "已转移到 {{count}} 个目标",
	transferDescription: "将 {{name}} 从 {{source}} 复制到：",
	noTransferDestinations: "没有可用的转移目标。",
	selectDestinationScope: "选择目标范围",
	selectScopePlaceholder: "选择范围...",
	selectAgentsForTransfer: "选择要转移到 {{destination}} 的代理：",
