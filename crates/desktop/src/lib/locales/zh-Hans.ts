export default {
	...
	usageLayoutResetOverride: "重置为默认",
	usageLayoutRestoreDefault: "恢复默认布局",
	usageLayoutUseDefault: "使用默认布局",
	usageLayoutDefaultRestored: "默认卡片布局已恢复",
	usageUndo: "撤销",
	usageLayoutAutosaveHint: "更改会自动保存。",
	usageLayoutKeyboardHint: "空格键拾取 · 方向键移动",
	usageLayoutLivePreview: "实时预览",
	usageLayoutPreviewAgent: "预览 Agent：{{agent}}",
	usageLayoutFields: "字段",
	usageLayoutFieldsDescription: "使用眼睛按钮显示或隐藏字段。",
	usageLayoutQuotaFields: "额度",
	usageLayoutStatFields: "统计",
	usageLayoutShowField: "显示{{field}}",
	usageLayoutHideField: "隐藏{{field}}",
