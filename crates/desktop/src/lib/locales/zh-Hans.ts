export default {
	...
	gatewayOfficialKeysDescription:
		"网关直连 Gemini、Claude、Codex 官方接口所用的 API Key。",
	gatewayNoUpstreamKeys: "暂无 API Key。",
	gatewayCompatTitle: "中转站 (OpenAI 兼容)",
	gatewayCompatDescription: "OpenAI 兼容的中转、聚合类上游。",
	gatewayAddCompatProvider: "添加中转站",
	gatewayNoCompatProviders: "暂无中转站。",
	gatewayCompatModelCount: "{{count}} 个模型",
	gatewayDeleteUpstream: "删除上游",
	gatewayDeleteUpstreamConfirm: "确定删除「{{name}}」？此操作无法撤销。",
	gatewayUpstreamKeyDeleted: "API Key 已删除",
	gatewayCompatProviderDeleted: "中转站已删除",
	gatewayUpstreamDeleteFailed: "删除上游失败",
	gatewayAddUpstreamKey: "添加 API Key",
	gatewayUpstreamApiKey: "API Key",
	gatewayUpstreamBaseUrl: "地址（可选）",
	gatewayUpstreamBaseUrlPlaceholder: "留空使用官方地址",
	gatewayUpstreamKeyAdded: "API Key 已添加",
	gatewayUpstreamAddFailed: "添加上游失败",
	validationGatewayApiKeyRequired: "请填写 API Key",
	gatewayImportFromInference: "从推理 Provider 导入",
	gatewayImportFromInferenceNone: "手动填写",
	gatewayCompatProviderAdded: "中转站已添加",
	gatewayCompatModels: "模型（可选，逗号分隔）",
	gatewayCompatModelsPlaceholder: "gpt-4o, deepseek-chat",
	gatewayResetQuota: "重置配额状态",
	gatewayQuotaReset: "配额状态已重置",
	gatewayQuotaResetFailed: "重置配额状态失败",
	gatewayManagedProviderTooltip: "由网关管理",
	gatewayManagedProviderNotice:
		"此条目由网关自动镜像，本地修改会在下次同步时被覆盖。",
	gatewayDeviceCodeHint: "在打开的页面确认此代码",
	gatewayDeviceCodeCopy: "复制代码",
	gatewayDeviceCodeCopied: "代码已复制",
	gatewayDeviceCodeCopyFailed: "复制代码失败",
	gatewayDeviceCodeExpiresIn: "{{time}} 后失效",
	gatewayTabLogs: "日志",
	gatewayLogsLineCount: "{{count}} 行",
	gatewayLogsClear: "清空",
	gatewayLogsClearConfirm: "确定清空日志？此操作无法撤销。",
	gatewayLogsCleared: "日志已清空",
	gatewayLogsClearFailed: "清空日志失败",
	gatewayLogsEmpty: "暂无日志。",
	gatewayLogsDisabled: "文件日志未开启",
	gatewayLogsDisabledDescription: "开启后网关会把日志写入文件，可在此查看。",
	gatewayLogsEnable: "开启文件日志",
	gatewayLogsLoadFailed: "加载日志失败",
	gatewayExcludedModelsTitle: "模型排除",
	gatewayExcludedModelsDescription: "限制 OAuth 账号可用的模型。",
	gatewayExcludedModelsHint: "模型名支持通配符，如 gemini-1.5*。",
	gatewayExcludedModelsAddRule: "添加规则",
	gatewayExcludedModelsEmpty: "暂无排除规则。",
	gatewayExcludedModelPlaceholder: "输入模型名后回车",
	gatewayExcludedModelsSaved: "模型排除已保存",
	gatewayExcludedModelsSaveFailed: "保存模型排除失败",
	gatewayImportVertex: "导入 Vertex",
	gatewayVertexImported: "Vertex 服务账号已导入",
	gatewayVertexImportFailed: "导入 Vertex 服务账号失败",
	gatewayVertexReadFailed: "读取文件失败",
	gatewayBinSourceEnv: "来源：AGHUB_CLIPROXY_BIN 环境变量",
	gatewayBinSourceDownloaded: "来源：aghub 下载 (v{{version}})",
	gatewaySystemBinHint:
		"检测到系统安装：{{path}} — 如需使用，请设置 AGHUB_CLIPROXY_BIN 指向它",
	gatewayInstallAndStart: "安装并启动",
	gatewayInstall: "安装",
	gatewayLaunchPreparing: "准备中…",
	gatewayLaunching: "启动中…",
	...
	gatewayMirrorDescription:
		"留空则从 GitHub 下载。镜像需提供与 GitHub releases 相同的 /releases/download 路径布局。",
	gatewayMirrorSaved: "下载源已保存",
	gatewayCliproxySettings: "CLIProxyAPI 设置",
	gatewayRemoteInstances: "远程实例",
	gatewayNoRemoteInstances: "尚未连接远程实例。",
	gatewayAddExternal: "连接远程实例",
	gatewayKindExternal: "外部",
	gatewayStatusNotProvisioned: "未下载",
	gatewayStatusStopped: "已停止",
	gatewayStatusStarting: "启动中",
	gatewayStatusRunning: "运行中",
	gatewayStatusUnhealthy: "异常",
	gatewayStart: "启动",
	gatewayStop: "停止",
	gatewayAutoStart: "随 aghub 启动",
	gatewayInstanceStarted: "实例已启动",
	gatewayInstanceStopped: "实例已停止",
	gatewayStartFailed: "启动实例失败",
	gatewayStopFailed: "停止实例失败",
	gatewayInstanceUpdated: "实例已更新",
	gatewayUpdateFailed: "更新实例失败",
	gatewayDeleteInstance: "删除实例",
	gatewayDeleteInstanceConfirm: "确定删除「{{name}}」？此操作无法撤销。",
	gatewayInstanceDeleted: "实例已删除",
	gatewayDeleteFailed: "删除实例失败",
	gatewayInstanceCreated: "实例已创建",
	gatewayCreateFailed: "创建实例失败",
	gatewayPort: "端口",
	gatewayBaseUrl: "地址",
	gatewayManagementKey: "Management key",
	gatewayConnect: "连接",
	gatewayExternalNamePlaceholder: "如：服务器网关",
	validationGatewayNameRequired: "请填写名称",
	validationGatewayBaseUrlRequired: "请填写地址",
	validationGatewayManagementKeyRequired: "请填写 management key",
	gatewayProvisionDownloading: "下载中…",
	gatewayProvisionReady: "CLIProxyAPI 已下载",
	gatewayProvisionFailed: "下载 CLIProxyAPI 失败",
	gatewayVersionInstalled: "已安装",
	gatewayVersionPinned: "锁定版本",
	gatewayVersionLatest: "最新",
	gatewayTabAccounts: "上游账号",
	gatewayTabKeys: "网关 Key",
	gatewayTabConfig: "config.yaml",
	gatewayTabUsage: "用量",
	gatewayInstanceNotRunning: "实例未运行",
	gatewayInstanceNotRunningDescription:
		"启动实例后才能管理账号、Key 和设置。",
	gatewayAccountsDescription: "实例转发请求所用的上游订阅账号。",
	gatewayAddAccount: "添加账号",
	gatewayAddAccountExternalHint:
		"外部实例无法接收 OAuth 回调，请先在本地实例登录，再把凭据推送过来（账号漫游）。",
	gatewayNoAccounts: "暂无上游账号",
	gatewayNoAccountsDescription: "添加订阅账号后，网关才能转发请求。",
	gatewayAccountProvider: "Provider",
	gatewayAccountEmail: "账号",
	gatewayAccountStatus: "状态",
	gatewayAccountModified: "修改时间",
	gatewayUsageSuccess: "成功",
	gatewayUsageFailed: "失败",
	gatewayUsageIdentifier: "上游标识",
	gatewayPushAccount: "推送到其它实例",
	gatewayPushTo: "推送到 {{name}}",
	gatewayAccountPushed: "凭据已推送到 {{name}}",
	gatewayPushFailed: "推送凭据失败",
	gatewayDeleteAccount: "删除账号",
	gatewayDeleteAccountConfirm: "确定删除「{{name}}」？此操作无法撤销。",
	gatewayAccountDeleted: "账号已删除",
	gatewayDeleteAccountFailed: "删除账号失败",
	gatewayOauthProviderLabel: "Provider",
	gatewayOauthStart: "用浏览器登录",
	gatewayOauthWaiting: "等待浏览器完成授权…",
	gatewayOauthSuccess: "账号已添加",
	gatewayOauthFailed: "登录失败",
	gatewayOauthTimeout: "等待授权超时",
	gatewayKeysDescription: "coding agent 用第一个 key 访问网关。",
	gatewayAddKey: "添加 Key",
	gatewayKeyPlaceholder: "sk-…",
	gatewayKeysSaved: "网关 Key 已保存",
	gatewayKeysSaveFailed: "保存网关 Key 失败",
	gatewayNoKeys: "暂无 Key，添加一个供 coding agent 接入。",
	gatewaySettingGroupLogging: "日志",
	gatewaySettingGroupUsage: "用量",
	gatewaySettingGroupSecurity: "安全",
	gatewaySettingGroupNetwork: "网络",
	gatewaySettingGroupQuota: "配额",
	gatewaySettingUpdated: "设置已保存",
	gatewaySettingUpdateFailed: "保存设置失败",
	gatewaySettingsWarningsTitle: "部分设置读取失败",
	gatewaySettingUnavailable: "不可用",
	gatewayConfigDescription:
		"routing 策略、模型别名等没有专属界面的高级项在此编辑。",
	gatewayConfigHotReload: "保存即热生效。",
	gatewayConfigSaved: "config.yaml 已保存",
	gatewayConfigSaveFailed: "保存 config.yaml 失败",
	gatewayNoUsage: "暂无用量数据",
	gatewayNoUsageDescription: "经此网关转发的请求会在这里统计。",
