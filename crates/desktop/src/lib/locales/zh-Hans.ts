export default {
	...
	agentWorkspaceSelectAgent: "选择一个 agent 浏览其配置文件",
	agentWorkspaceSelectFile: "选择文件以查看或编辑",
	agentWorkspaceEmptyDirectory: "空目录",
	agentWorkspaceSave: "保存",
	agentWorkspaceCancel: "取消",
	agentWorkspaceEdit: "编辑",
	agentWorkspaceSaved: "文件保存成功",
	agentWorkspaceSaveFailed: "保存文件失败",
	agentWorkspaceRawEditor: "原始编辑器",
	agentWorkspaceSections: "分区视图",
