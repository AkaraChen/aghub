export default {
	...
	usageStatusInstall: "安装",
	usageSidecarAutoDiscover: "自动发现 ccusage",
	...
	usageOfflinePricingDescription:
		"使用 ccusage 的缓存价格;关闭则联网取实时定价。",
	usageRequestTimeout: "请求超时",
	usageRequestTimeoutDescription: "等待 ccusage 的最长时间,超时则放弃。",
	...
	usageSettingsTrackedAgents: "追踪的 agent",
	usageSettingsTrackedAgentsDescription:
		"取消追踪的 agent 不再出现在主页卡片与用量页。",
	...
	usageLayoutEmptyCard: "全部隐藏了——从右侧加回字段。",
