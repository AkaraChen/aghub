export default {
	...
	gatewayPageDescription:
		"托管本地 LLM 网关，或连接已在运行的 CLIProxyAPI 实例。",
	gatewayAddManaged: "托管本地网关",
	gatewayAddExternal: "连接现有实例",
	gatewayEmptyManagedDescription:
		"aghub 自动下载 CLIProxyAPI 二进制并管理进程。",
	gatewayEmptyExternalDescription:
		"填写地址与 management key，连接已在别处运行的 CLIProxyAPI。",
	gatewayKindManaged: "托管",
