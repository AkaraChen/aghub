export default {
	...
	subAgents: "子Agent",
	subAgent: "子Agent",
	createSubAgent: "创建子Agent",
	editSubAgent: "编辑子Agent",
	deleteSubAgent: "删除子Agent",
	noSubAgents: "暂无子Agent",
	noSubAgentsDescription: "创建你的第一个子Agent。",
	searchSubAgents: "搜索子Agent...",
	subAgentName: "名称",
	subAgentDescription: "描述",
	subAgentInstruction: "指令",
	subAgentCreated: "子Agent已创建",
	subAgentUpdated: "子Agent已更新",
	subAgentDeleted: "子Agent已删除",
	createSubAgentError: "创建子Agent失败",
	subAgentNoInstruction: "未设置指令。",
	deleteSubAgentConfirm: '确定要删除"{{name}}"吗？此操作无法撤销。',
	updateSubAgentError: "更新子Agent失败",
	deleteSubAgentError: "删除子Agent失败",
	subAgentNamePlaceholder: "例如：code-reviewer",
	subAgentDescriptionPlaceholder: "这个子Agent的作用是什么？",
	subAgentInstructionPlaceholder: "子Agent的系统提示词/指令...",
	prompts: "提示词",
	noPrompts: "暂无提示词",
	...
	noAgentsDescription: "安装 Agent 后即可在此管理。",
	searchAgentsLabel: "搜索 Agent",
	searchAgents: "搜索 Agent...",
	agentStatusFilterLabel: "按状态筛选 Agent",
	...
	agentManagementDescription:
		"管理哪些 Agent 可用于创建技能和 MCP 服务器。禁用你不使用的 Agent。",
	globalConfig: "全局配置",
	cli: "命令行工具",
	ide: "IDE",
	desktop: "桌面应用",
	cloud: "云端",
	remoteWorkspace: "远端工作区",
	detectedVia: "通过 {{sources}} 检测到",
	supportedAgents: "aghub 支持的 Agent",
	configurationCanBePrepared: "可以预先准备配置",
	configurationFoundRuntimeUnknown: "已发现配置，但尚未确认客户端运行时",
	detectionFailedCanPrepare: "检测失败，仍可预先准备配置",
	detectionUnknownCanPrepare: "暂无可靠检测方式，仍可预先准备配置",
	prepareConfigRuntimeUnconfirmed:
		"aghub 将准备配置文件，但尚未确认这个 Agent 的运行时。",
	available: "可用",
	notAvailable: "不可用",
	disabledByUser: "已禁用",
	toggleAgent: "切换 {{name}}",
	...
	deleteMcpMultipleConfirm:
		"将从 {{count}} 个 Agent 中移除「{{name}}」（{{agents}}）。此操作无法撤销。",
	deleting: "删除中...",
	editMcpServer: "编辑 MCP 服务器",
	multipleAgents: "多个 Agent",
	changeWillApplyToAgents: "此更改将应用于 {{count}} 个 Agent：{{agents}}",
	name: "名称",
	serverName: "服务器名称",
	transportType: "传输类型",
	env: "环境变量",
	...
	noAgentsAvailableHelp: "请先安装或启用至少一个支持组件管理的 Agent。",
	...
	validationAgentsRequired: "请至少选择一个 Agent。",
	...
	manageAgentsTooltip: "选择使用此服务器的 Agent",
	adding: "添加",
	removing: "移除",
	alreadyAdded: "已添加",
	...
	unconfigured: "未配置",
	applyChanges: "应用更改",
	agentChangesApplied: "已成功更新 {{count}} 个 Agent",
	...
	selectAgentsForMcp: "选择哪些 Agent 应安装此 MCP 服务器：",
	noTargetAgents: "没有可用的 Agent。",
	...
	universalSkillsDescription: "{{count}} 个 Agent 共享此技能路径",
	...
	installSkill: "安装技能",
	selectSourceAndAgents: "选择来源和 Agent",
	installation: "安装",
	install: "安装",
	...
	selectAgentsForSkill: "选择要安装此技能的 Agent：",
	selectAgentsForSubAgent: "选择应使用此子Agent的 Agent Harness：",
	installs: "安装量",
	...
	executableMcpWarningDescription:
		"Stdio MCP 服务器是 Agent 稍后可能运行的可执行命令。仅当你信任来源，并已查看下方的所有命令、参数和环境变量后才安装。",
	confirmExecutableMcp:
		"我了解此导入会持久保存一个可执行命令，供 Agent 稍后运行。",
	...
	skillSyncFailed: "无法同步此 Skill。{{error}}",
	skillSyncCredentialHint:
		"检查来源和网络后重试。私有仓库可选择已保存的凭证。",
	...
	library: "技能库",
	market: "市场",
	marketSubtitle: "发现技能、MCP 服务器与开箱即用的 Agent 包。",
	marketSections: "市场板块",
	...
	marketMcpInputs: "配置",
	marketMcpRequired: "此项为必填项。",
	marketMcpInvalidValue: "请输入有效值。",
	...
	marketMcpSourceRemove: "移除此源",
	marketMcpSourceAddTitle: "添加 MCP registry 源",
	marketMcpSourceNamePlaceholder: "例如：自定义 registry",
	marketMcpSourceUrlHint: "须在公开 HTTP(S) 端点上提供 MCP Registry API。",
	...
	clearAgentFilter: "清除 Agent 筛选",
	agentFilterAllAgents: "全部 Agent",
	agentFilterIdleLabel: "按 Agent 筛选",
	agentFilterActiveLabel: "正在筛选 {{name}} — 点击更换",
	agentFilterChangeLabel: "更换 Agent 筛选",
	...
	sidebarShowLess: "收起",
	homeTitle: "Agent Hub",
	homeSubtitle: "管理本机 Agent Harness 的模型、技能、MCP 与用量。",
	open: "打开",
	manage: "管理",
	model: "模型",
	manageAgentHarnesses: "管理 Agent Harness",
	manageAgentHarnessesHint: "管理本机已识别的 Agent Harness。",
	browseLibrary: "浏览技能库",
	quickActions: "快捷操作",
	agentStatusReady: "就绪",
	...
	agentMissingHint:
		"此 Agent Harness 尚未安装。请先安装其 CLI，再来这里管理。",
	agentDisabledHint: "此 Agent Harness 已停用。请前往设置重新启用。",
	modelNotConfigurableTitle: "模型由 Agent 自行管理",
	modelNotConfigurableHint: "{{name}} 从自身设置读取模型配置，这里无需管理。",
	agentSections: "Agent 分区",
	...
	globalSearchLabel:
		"搜索 Agent、技能、MCP 服务器、子Agent、提示词、规则与技能库",
