export default {
	...
	usageStatusRecheck: "重新检测",
	usageRuntimeSource: "运行来源",
	usageRuntimeSourceAuto: "自动",
	usageRuntimeSourceEnvironment: "环境变量覆盖",
	usageRuntimeSourceManual: "自定义二进制",
	usageRuntimeSourcePath: "系统 PATH",
	usageRuntimeSourceBun: "使用 Bun 安装",
	usageRuntimeSourceNpm: "使用 npm 安装",
	usageRuntimeSourceDownload: "直接下载",
	usageRuntimeSourceBundled: "内置备用版本",
	usageRuntimeAutoDescription:
		"依次使用环境变量覆盖、PATH、应用管理的安装和内置备用版本。",
	usageRuntimeExternalDescription: "使用现有的 ccusage，不会修改它。",
	usageRuntimeBundledDescription: "使用当前 aghub 版本随附的只读副本。",
	usageRuntimeManagedInstalledDescription:
		"使用安装在 aghub 应用数据目录中的副本。",
	usageRuntimeManagedInstallDescription:
		"将校验过的 ccusage 原生二进制安装到 aghub 应用数据目录。",
	usageRuntimeExternalManaged:
		"此运行来源由 aghub 外部管理。在这里更新会另行安装一份由应用管理的副本。",
	...
	usageRuntimeUse: "使用",
	usageRuntimeInstall: "安装",
	usageRuntimeInstallManaged: "在 aghub 中安装最新版",
