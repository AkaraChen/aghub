export default {
	...
	globalHooksCount: "{{count}} 个全局 hook",
	createHook: "创建 hook",
	editHook: "编辑 hook",
	deleteHook: "删除 hook",
	deleteHookConfirm: "确定要删除「{{event}}」hook 吗？此操作无法撤销。",
	noHooks: "暂无 hooks",
	noHooksMatch: "没有匹配的 hooks",
	searchHooks: "搜索 hooks...",
	hookEvent: "事件",
	hookMatcher: "Matcher",
	hookActionType: "动作类型",
	hookCommand: "命令",
	...
	hookStatusMessagePlaceholder: "hook 运行时显示",
	hookIfCondition: "条件",
	hookAsync: "异步运行",
	hookPromptPlaceholder: "Prompt 内容",
	hookCreated: "Hook 已创建",
	hookUpdated: "Hook 已更新",
	hookDeleted: "Hook 已删除",
	hookLoadError: "加载 hooks 失败",
	hookSaveError: "保存 hook 失败",
	hookDeleteError: "删除 hook 失败",
	hookEventRequired: "事件必填",
	hookCommandRequired: "命令必填",
	hookUrlRequired: "URL 必填",
	hookPromptRequired: "Prompt 必填",
	hookServerRequired: "MCP 服务器必填",
	hookToolRequired: "MCP 工具必填",
	hookTimeoutInvalid: "超时必须大于 0",
	codexGlobalHookTarget:
		"新的 Codex hook 会保存到 ~/.codex/hooks.json；已有 hook 会在原来源文件中更新。",
	claudeGlobalHookTarget: "Claude hook 会保存到 ~/.claude/settings.json。",
