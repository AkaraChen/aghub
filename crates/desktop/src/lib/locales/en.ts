export default {
	...
	globalHooksCount: "{{count}} global hook(s)",
	createHook: "Create hook",
	editHook: "Edit hook",
	deleteHook: "Delete hook",
	deleteHookConfirm: 'Delete the "{{event}}" hook? This can\'t be undone.',
	noHooks: "No hooks",
	noHooksMatch: "No hooks match",
	searchHooks: "Search hooks...",
	hookEvent: "Event",
	hookMatcher: "Matcher",
	hookActionType: "Action type",
	hookCommand: "Command",
	hookUrl: "URL",
	hookPrompt: "Prompt",
	hookServer: "MCP server",
	hookTool: "MCP tool",
	hookTimeout: "Timeout seconds",
	hookStatusMessage: "Status message",
	hookStatusMessagePlaceholder: "Shown while the hook runs",
	hookIfCondition: "Condition",
	hookAsync: "Run asynchronously",
	hookPromptPlaceholder: "Prompt content",
	hookCreated: "Hook created",
	hookUpdated: "Hook updated",
	hookDeleted: "Hook deleted",
	hookLoadError: "Failed to load hooks",
	hookSaveError: "Failed to save hook",
	hookDeleteError: "Failed to delete hook",
	hookEventRequired: "Event is required",
	hookCommandRequired: "Command is required",
	hookUrlRequired: "URL is required",
	hookPromptRequired: "Prompt is required",
	hookServerRequired: "MCP server is required",
	hookToolRequired: "MCP tool is required",
	hookTimeoutInvalid: "Timeout must be greater than 0",
	codexGlobalHookTarget:
		"New Codex hooks are saved to ~/.codex/hooks.json. Existing hooks are updated in their source file.",
	claudeGlobalHookTarget:
		"Claude hooks are saved to ~/.claude/settings.json.",
