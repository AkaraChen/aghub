export default {
	...
	gatewayPageDescription:
		"Host a local LLM gateway or connect to a running CLIProxyAPI instance.",
	gatewayAddManaged: "Host local gateway",
	gatewayAddExternal: "Connect existing instance",
	gatewayEmptyManagedDescription:
		"aghub downloads the CLIProxyAPI binary and manages the process for you.",
	gatewayEmptyExternalDescription:
		"Point aghub at a CLIProxyAPI already running elsewhere using its address and management key.",
	gatewayKindManaged: "Managed",
	...
	gatewayRenameInstance: "Rename instance",
