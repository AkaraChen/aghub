export default {
	...
	transferApplied: "Transferred to {{count}} target(s)",
	transferDescription: "Copy {{name}} from {{source}} to:",
	noTransferDestinations: "No destinations available for transfer.",
	selectDestinationScope: "Select destination scope",
	selectScopePlaceholder: "Choose a scope...",
	selectAgentsForTransfer: "Select agents to transfer to {{destination}}:",
