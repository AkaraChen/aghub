export default {
	...
	usageUndo: "Undo",
	usageLayoutAutosaveHint: "Changes save automatically.",
	usageLayoutKeyboardHint: "Space to pick up · Arrow keys to move",
	usageLayoutLivePreview: "Live preview",
	usageLayoutPreviewAgent: "Preview agent: {{agent}}",
	usageLayoutFields: "Fields",
	usageLayoutFieldsDescription:
		"Use the eye controls to show or hide fields.",
	usageLayoutQuotaFields: "Quota",
	usageLayoutStatFields: "Statistics",
	usageLayoutShowField: "Show {{field}}",
	usageLayoutHideField: "Hide {{field}}",
