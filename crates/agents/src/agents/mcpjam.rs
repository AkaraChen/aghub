...
fn data_dir() -> Option<PathBuf> {
	home_dir().map(|home| home.join(".mcpjam"))
}
...
pub const DESCRIPTOR: AgentDescriptor = AgentDescriptor {
	...
	display_name: "MCPJam",
	surfaces: &[
		AgentSurface::cli("cli", &["mcpjam"], &[data_dir], &["--version"]),
